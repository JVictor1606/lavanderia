...
class LoginController extends SharedController
{
    ...
    public function index(): string
    {
        ...
        return self::getPage('LAVANDERIA - LOGIN', $content, options: [
            'showSidebar' => false,
    ...
    public function esqueciSenha(): string
    {
        ...
        return parent::getPage('LAVANDERIA - ESQUECI MINHA SENHA', $content, [
            'showSidebar' => false,
            'bodyClass' => 'login-page',
        ]);
    }
    ...
    public function verificarEmail(): string
    {
        ...
        return parent::getPage('LAVANDERIA - VERIFICAR CÓDIGO', $content, [
            'showSidebar' => false,
            'bodyClass' => 'login-page',
            'toast' => $toast,
        ]);
    ...
    public function verificarCodigo(): string
    {
        ...
        return self::getPage('LAVANDERIA - REDEFINIR SENHA', $content, [
            'showSidebar' => false,
            'bodyClass' => 'login-page',
            'toast' => $toast,
        ]);
    ...
    public function redefinirSenha()
    {
        ...
        if ($validated->fails()) {
            ...
            return parent::getPage('LAVANDERIA - REDEFINIR SENHA', $content, [
                'showSidebar' => false,
                'bodyClass' => 'login-page',
                'toast' => Toast::pull(),
            ]);
